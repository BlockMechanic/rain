...
// rain includes.
#include <..\src\script\rainconsensus.h>
...
int main()
{
    std::cout << "rainconsensus version: " << rainconsensus_version() << std::endl;
    ...
    auto op0Result = rainconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, rainconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
