...
Rain Core version 0.19.1 is now available from:

  <https://raincore.org/bin/rain-core-0.19.1/>
...
From Rain Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Rain Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Rain Core does not yet change appearance when
...
- #17488 fix "raind already running" warnings on macOS (fanquake)
