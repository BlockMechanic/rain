Download URL: https://sourceforge.net/projects/rain/files/Rain/rain-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 RAIN fee schedule (users still pay 0.01 RAIN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #rain00 - #rain99
