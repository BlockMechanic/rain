Rain Core version 0.13.2 is now available from:

  <https://rain.org/bin/rain-core-0.13.2/>
...
- #8908 `4a974b2` Update rain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow rain-tx to create v2 transactions (btcdrak)
