Rain-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/rain/files/Rain/rain-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Rain
...
New/changed settings (command-line or rain.conf file)
--------------------------------------------------------
