Rain version 0.5.4 is now available for download at:
http://sourceforge.net/projects/rain/files/Rain/rain-0.5.4/
...
http://gitorious.org/rain/raind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Rain-Qt notifications under Growl 1.3.
Increase required age of Rain-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxRain properly when installing Rain-Qt over it. (Windows)
