Rain Core version 0.10.4 is now available from:

  <https://rain.org/bin/rain-core-0.10.4/>
...
- #6953 `43c2789` Split rain-tx into its own package
- #6953 `dfe0d4d` Include rain-tx binary on Debian/Ubuntu
