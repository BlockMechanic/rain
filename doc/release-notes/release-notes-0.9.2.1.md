Rain Core version 0.9.2.1 is now available from:

  https://rain.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 RAIN to 0.01 RAIN
...
- Fix "Start rain on system login"
