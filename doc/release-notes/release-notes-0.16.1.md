Rain Core version 0.16.1 is now available from:

  <https://raincore.org/bin/rain-core-0.16.1/>
...
- #12843 `df38b13` Test starting raind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure raind processes are cleaned up when tests end (sdaftuar)
