...
This document provides guidelines for internationalization of the Rain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rain_en.ts` remains unchanged.
