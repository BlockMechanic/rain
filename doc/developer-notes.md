...
Rain Core uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
Run with the `-testnet` option to run with "play rains" on the test network, if you
...
- Use include guards to avoid the problem of double inclusion. The header file
  `foo/bar.h` should use the include guard identifier `SUPERCOIN_FOO_BAR_H`, e.g.

```c++
#ifndef SUPERCOIN_FOO_BAR_H
#define SUPERCOIN_FOO_BAR_H
...
#endif // SUPERCOIN_FOO_BAR_H
```
...
Commit [`bb81e173`](https://github.com/rain/rain/commit/bb81e173) is an example of a scripted-diff.
