...
rain.conf        | contains configuration settings for raind or rain-qt
raind.pid        | stores the process id of raind while running
...
debug.log           | contains debug information and general logging generated by raind or rain-qt
