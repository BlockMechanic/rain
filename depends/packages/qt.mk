...
$(package)_patches+= fix_android_qmake_conf.patch fix_android_base_head_conf.patch
$(package)_patches+= fix_mingw_cross_compile.patch xkb-default.patch fix_xkbcommon.patch
...
$(package)_config_opts_arm_linux += -platform linux-g++ -xplatform rain-linux-g++
$(package)_config_opts_i686_linux  = -xplatform linux-g++-32
$(package)_config_opts_x86_64_linux = -xplatform linux-g++-64
$(package)_config_opts_aarch64_linux = -xplatform linux-aarch64-gnu-g++
$(package)_config_opts_powerpc64_linux = -platform linux-g++ -xplatform rain-linux-g++
$(package)_config_opts_powerpc64le_linux = -platform linux-g++ -xplatform rain-linux-g++
$(package)_config_opts_riscv64_linux = -platform linux-g++ -xplatform rain-linux-g++
$(package)_config_opts_s390x_linux = -platform linux-g++ -xplatform rain-linux-g++
$(package)_config_opts_linux += -L $(host_prefix)/lib -I $(host_prefix)/include

$(package)_config_opts_mingw32 = -opengl desktop
$(package)_config_opts_mingw32 += -no-dbus
$(package)_config_opts_mingw32 += -no-eglfs
...
$(package)_config_opts_android += -no-egl
...
# rain-linux-g++, replace instances of linux-arm-gnueabi with $(host). This
...
define $(package)_preprocess_cmds
  ...
  patch -p1 -i $($(package)_patch_dir)/fix_android_base_head_conf.patch && \
  ...
  cp -r qtbase/mkspecs/linux-arm-gnueabi-g++ qtbase/mkspecs/rain-linux-g++ && \
  sed -i.old "s/arm-linux-gnueabi-/$(host)-/g" qtbase/mkspecs/rain-linux-g++/qmake.conf && \
