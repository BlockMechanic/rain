...
$(package)_patches=fix_threads.patch

define $(package)_preprocess_cmds
    patch -p1 -i $($(package)_patch_dir)/fix_threads.patch
endef
...
define $(package)_set_vars
  ...
  $(package)_config_opts_android=-DOPSYS=ANDROID -DCMAKE_SYSTEM_NAME=Android -DARCH=ARM -DWSIZE=64 -DARITH=GMP
  $(package)_config_opts_android += $(host_prefix)/lib
  $(package)_config_opts_android += $(host_prefix)/include
  ...
  $(package)_config_opts_aarch64+= -DWSIZE=64 -DCMAKE_POSITION_INDEPENDENT_CODE=ON
  $(package)_config_opts_armv7a+= -DWSIZE=32
