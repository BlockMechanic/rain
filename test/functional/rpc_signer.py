...
Verify that a raind node can use an external signer command.
...
class RPCSignerTest(RainTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart raind with -signer=<cmd>',
