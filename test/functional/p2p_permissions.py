...
class P2PPermissionsTests(RainTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].rainconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].rainconf, 'w', encoding="utf8") as f:
            f.write(newText)
