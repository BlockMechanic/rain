...
class TestShell:
    """Wrapper Class for RainTestFramework.

    The TestShell class extends the RainTestFramework
    ...
    class __TestShell(RainTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by RainTestFramework child class.
            self.num_nodes = 1
