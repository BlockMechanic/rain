...
"""Verify that starting rain with -h works as expected."""

from test_framework.test_framework import RainTestFramework
from test_framework.util import assert_equal

class HelpTest(RainTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rain with -h for help text")
        ...
        self.log.info("Start rain with -version for version information")
        ...
        self.log.info("Start raind with -fakearg to make sure it does not start")
