...
For an immediately usable, binary version of the Rain Core software, see
https://raincore.org/en/download/.

Further information about Rain Core is available in the [doc folder](/doc).
...
For more information read the original Rain whitepaper.
