...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the rain repository."
  exit 1
fi
...
# See https://github.com/rain/rain/issues/16064
...
echo
echo 'When compiling raind, run `./configure` in the following way:'
echo
