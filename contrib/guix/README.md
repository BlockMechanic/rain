# Bootstrappable Rain Core Builds

This directory contains the files necessary to perform bootstrappable Rain
Core builds.
...
From the top of a clean Rain Core repository:
...
To use dongcarl's substitute server for Rain Core builds after having
