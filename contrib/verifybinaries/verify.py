...
def main(args):
    ...
    if not success:
        print("rain.org failed to provide signature file, "
              "but raincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("rain.org and raincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Rain Core binary release "
