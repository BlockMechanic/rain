...
#include <config/rain-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatRainURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + RainUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatRainURI(info));
}
