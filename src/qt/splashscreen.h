...
#ifndef SUPERCOIN_QT_SPLASHSCREEN_H
#define SUPERCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Rain Core initialization
...
#endif // SUPERCOIN_QT_SPLASHSCREEN_H
