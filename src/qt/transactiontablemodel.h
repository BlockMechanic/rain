...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, RainUnits::SeparatorStyle separators=RainUnits::SeparatorStyle::STANDARD) const;
