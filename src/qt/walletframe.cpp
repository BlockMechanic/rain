...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, RainGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &RainGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &RainGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &RainGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &RainGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &RainGUI::updateWalletStatus);
    connect(gui, &RainGUI::setPrivacy, walletView, &WalletView::setPrivacy);
