    ...
    mapper(nullptr)
{
    ...
    ui->rainAtStartup->setToolTip(ui->rainAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->rainAtStartup->setText(ui->rainAtStartup->text().arg(PACKAGE_NAME));

    ui->openRainConfButton->setToolTip(ui->openRainConfButton->toolTip().arg(PACKAGE_NAME));
