    ...
    mapper(nullptr)
{
    ...
    ui->rainAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->rainAtStartup);
    ...
    ui->rainAtStartup->setToolTip(ui->rainAtStartup->toolTip().arg("Rain"));
    ui->rainAtStartup->setText(ui->rainAtStartup->text().arg("Rain"));

    ui->openRainConfButton->setToolTip(ui->openRainConfButton->toolTip().arg("Rain"));

    ui->lang->setToolTip(ui->lang->toolTip().arg("Rain"));
    ...
    ui->unit->setModel(new RainUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->rainAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openRainConfButton_clicked()
{
