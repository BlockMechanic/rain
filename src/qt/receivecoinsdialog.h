...
#ifndef SUPERCOIN_QT_RECEIVECOINSDIALOG_H
#define SUPERCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of rains */
...
#endif // SUPERCOIN_QT_RECEIVECOINSDIALOG_H
