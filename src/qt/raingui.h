...
#ifndef RAIN_QT_RAINGUI_H
#define RAIN_QT_RAINGUI_H
...
/**
  Rain GUI main class. This class represents the main window of the Rain UI. It communicates with both the client and
...
public:
    ...
    explicit RainGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~RainGUI();
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Rain Transaction from file or clipboard */
