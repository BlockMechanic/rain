...
/* A AEAD class for ChaCha20-Poly1305@rain.
 *
 ...
 *
 * The chacha20-poly1305@rain combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@rain cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@rain are relatively fast in
