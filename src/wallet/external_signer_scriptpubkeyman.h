...
#ifndef RAIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define RAIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // RAIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
