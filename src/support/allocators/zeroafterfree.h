...
#ifndef SUPERCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define SUPERCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // SUPERCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
