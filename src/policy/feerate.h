...
const std::string CURRENCY_UNIT = "RAIN"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    RAIN_KVB,      //!< Use RAIN/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from RAIN/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::RAIN_KVB) const;
