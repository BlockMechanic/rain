...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
            ...
            + "If you are running the rain core wallet, you can get a new address to send the newly generated rain to with:\n"
...
UniValue getwork(const JSONRPCRequest& request)
{
    ...
    if (::ChainstateActive().IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Cryptorain is downloading blocks...");
...
static UniValue submitblock(const JSONRPCRequest& request)
{
    ...
    bool accepted = ProcessNewBlock(Params(), blockptr, /* fForceProcessing */ true, /* fNewBlock */ &new_block, *g_connman);
