...
#ifndef SUPERCOIN_PRIMITIVES_TRANSACTION_H
#define SUPERCOIN_PRIMITIVES_TRANSACTION_H
...
static const int SERIALIZE_TRANSACTION_NO_WITNESS = 0x10000000;
...
#endif // SUPERCOIN_PRIMITIVES_TRANSACTION_H
