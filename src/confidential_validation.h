...
#ifndef RAIN_CONFIDENTIAL_VALIDATION_H
#define RAIN_CONFIDENTIAL_VALIDATION_H
...
private:
    ...
    const bool store;
public:
    CSurjectionCheck(secp256k1_surjectionproof& proof_in, std::vector<secp256k1_generator>& tags_in, secp256k1_generator& gen_in, uint256& txid_in, const bool store_in) : proof(proof_in), vTags(tags_in), gen(gen_in), txid(txid_in), store(store_in) {}
...
#endif // RAIN_CONFIDENTIAL_VALIDATION_H
