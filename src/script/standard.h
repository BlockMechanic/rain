...
#ifndef RAIN_SCRIPT_STANDARD_H
#define RAIN_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    //Cold Staking
    TX_COLDSTAKE,
    //Contracts note:: add for escrow and other types
    TX_HTLC,
    TX_CLTV,
    TX_MULTISIG_CLTV
};
 ...
 */
bool ExtractDestination(const CScript& scriptPubKey, CTxDestination& addressRet, txnouttype* typeRet = nullptr, bool fColdStake = false);
...
/**
 * Generate a Rain scriptPubKey for the given CTxDestination. Returns a P2PKH
