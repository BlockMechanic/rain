...
#ifndef SUPERCOIN_TEST_SCRIPTNUM10_H
#define SUPERCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Rain Core 0.10.0, for cross-comparison.
 */
public:
