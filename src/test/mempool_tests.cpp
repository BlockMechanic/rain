...
BOOST_AUTO_TEST_CASE(MempoolIndexingTest)
{
    ...
    pool.addUnchecked(entry.Fee(populateMap(10000LL)).FromTx(tx1));
    ...
    pool.addUnchecked(entry.Fee(populateMap(20000LL)).FromTx(tx2));
    ...
    pool.addUnchecked(entry.Fee(populateMap(0LL)).FromTx(tx3));
    ...
    pool.addUnchecked(entry.Fee(populateMap(15000LL)).FromTx(tx4));
    ...
    entry.nTime = 1;
    pool.addUnchecked(entry.Fee(populateMap(10000LL)).FromTx(tx5));
    ...
    pool.addUnchecked(entry.Fee(populateMap(0LL)).FromTx(tx6));
    ...
    std::string dummy;
    BOOST_CHECK_EQUAL(pool.CalculateMemPoolAncestors(entry.Fee(populateMap(2000000LL)).FromTx(tx7), setAncestorsCalculated, 100, 1000000, 1000, 1000000, dummy), true);
    ...
    pool.addUnchecked(entry.Fee(populateMap(0LL)).Time(2).FromTx(tx8), setAncestors);
    ...
    pool.addUnchecked(entry.Fee(populateMap(0LL)).Time(3).FromTx(tx9), setAncestors);
    ...
    BOOST_CHECK_EQUAL(pool.CalculateMemPoolAncestors(entry.Fee(populateMap(200000LL)).Time(4).FromTx(tx10), setAncestorsCalculated, 100, 1000000, 1000, 1000000, dummy), true);
    BOOST_CHECK(setAncestorsCalculated == setAncestors);
...
BOOST_AUTO_TEST_CASE(MempoolAncestorIndexingTest)
{
    ...
    pool.addUnchecked(entry.Fee(populateMap(fee)).FromTx(tx7));
    BOOST_CHECK_EQUAL(pool.size(), 7U);
    ...
    pool.addUnchecked(entry.Fee(populateMap(5000LL)).FromTx(tx8));
...
BOOST_AUTO_TEST_CASE(MempoolSizeLimitTest)
{
    ...
    pool.addUnchecked(entry.Fee(populateMap(5000LL)).FromTx(tx2));
    ...
    pool.addUnchecked(entry.Fee(populateMap(20000LL)).FromTx(tx3));
    ...
    CFeeRate maxFeeRateRemoved(populateMap(25000), GetVirtualTransactionSize(CTransaction(tx3)) + GetVirtualTransactionSize(CTransaction(tx2)));
    ...
    pool.addUnchecked(entry.Fee(populateMap(7000LL)).FromTx(tx4));
    pool.addUnchecked(entry.Fee(populateMap(1000LL)).FromTx(tx5));
    pool.addUnchecked(entry.Fee(populateMap(1100LL)).FromTx(tx6));
    pool.addUnchecked(entry.Fee(populateMap(9000LL)).FromTx(tx7));
   ...
   // BOOST_CHECK_EQUAL(pool.GetMinFee(populateMap(1)).GetFeePerK(), llround((maxFeeRateRemoved.GetFeePerK() + 1000)/2.0));
...
BOOST_AUTO_TEST_CASE(MempoolAncestryTests)
{
    ...
    pool.addUnchecked(entry.Fee(populateMap(10000LL)).FromTx(tx2));
    ...
    pool.addUnchecked(entry.Fee(populateMap(10000LL)).FromTx(tx3));
    ...
    pool.addUnchecked(entry.Fee(populateMap(10000LL)).FromTx(tx4));
    ...
    for (uint64_t i = 0; i < 5; i++) {
        ...
        v -= 50 * CENT;
        pool.addUnchecked(entry.Fee(populateMap(10000LL)).FromTx(tyi));
    ...
    pool.addUnchecked(entry.Fee(populateMap(10000LL)).FromTx(ty6));
