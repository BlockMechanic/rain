...
{
    BlockFilterIndex filter_index(BlockFilterType::BASICS, 1 << 20, true);
...
BOOST_FIXTURE_TEST_CASE(blockfilter_index_init_destroy, BasicTestingSetup)
{
    ...
    filter_index = GetBlockFilterIndex(BlockFilterType::BASICS);
    BOOST_CHECK(filter_index == nullptr);

    BOOST_CHECK(InitBlockFilterIndex(BlockFilterType::BASICS, 1 << 20, true, false));

    filter_index = GetBlockFilterIndex(BlockFilterType::BASICS);
    BOOST_CHECK(filter_index != nullptr);
    BOOST_CHECK(filter_index->GetFilterType() == BlockFilterType::BASICS);
    ...
    BOOST_CHECK(DestroyBlockFilterIndex(BlockFilterType::BASICS));
