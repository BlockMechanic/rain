...
enum ServiceFlags : uint64_t {
    ...
    // Rain Core nodes used to support this by default, without advertising this bit,
    ...
    // rain-development mailing list. Remember that service bits are just
...
enum GetDataMsg
{
    ...
    MSG_SPORK = 6,
    /* 7 - 15 were used in old Rain versions and were mainly budget and MN broadcast/ping related*/
    MSG_DSTX = 16,
