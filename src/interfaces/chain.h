...
//! internal workings of the rain node, and not being very convenient to use.
...
//!   asynchronously
//!   (https://github.com/rain/rain/pull/10973#issuecomment-380101269).
//!
//! * The relayTransactions() and submitToMemoryPool() methods could be replaced
//!   with a higher-level broadcastTransaction method
//!   (https://github.com/rain/rain/pull/14978#issuecomment-459373984).
//!
//! * The initMessages() and loadWallet() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/rain/rain/pull/15288#discussion_r253321096).
//!
...
public:
    ...
    public:
        ...
        virtual bool checkStakeKernelHash(CValidationState& state, unsigned int nBits, CBlockIndex* pindexPrev, const CBlockHeader& blockFrom, unsigned int nTxPrevOffset, const CTransactionRef& txPrev, const COutPoint& prevout, unsigned int nTimeTx, uint256& hashProofOfStake, bool fPrintProofOfStake) =0;
