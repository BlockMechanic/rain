...
extern CAmountMap GetBlockSubsidy(unsigned int nHeight, const Consensus::Params& consensusParams, bool fProofofStake = false, int64_t nCoinAge = 0, CAmountMap supply = CAmountMap());
